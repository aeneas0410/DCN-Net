general_config = {
    ...
    'dataset_info' : {
        ...
        'sar': {
            'dataset_filename': ['Duke_Random_Excitations_set1', 'Duke_Random_Excitations_set2',
                                 'Duke_Random_Excitations_set3', 'Duke_Random_Excitations_set4',
                                 'Duke_data_Quadrature.mat'],
            'format': 'nii.gz',
            'image_modality': ['B1_mag','B1_real','B1_imag','Epsilon','Rho','Sigma'], #['B1_mag','B1_real','B1_imag','Epsilon','Rho','Sigma'],
            'augment_data': (0,0),
